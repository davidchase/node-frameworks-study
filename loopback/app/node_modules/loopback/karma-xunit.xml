<?xml version="1.0"?>
<testsuites>
  <testsuite name="PhantomJS 1.9.7 (Mac OS X)" package="" timestamp="2014-06-26T11:33:53" id="0" hostname="kompx.local" tests="84" errors="0" failures="0" time="0.117">
    <properties>
    ...
    <testcase name="Save an instance of a Model to the attached data source" time="0.007" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model Tests model_save([options], [callback])"/>
    <testcase name="Save specified attributes to the attached data source" time="0.012" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model Tests model_updateAttributes(data, [callback])"/>
    <testcase name="Update when record with id=data.id found, insert otherwise" time="0.011" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model Tests Model_upsert(data, callback)"/>
    <testcase name="Remove a model from the attached data source" time="0.011" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model Tests model_destroy([callback])"/>
    <testcase name="Delete a model instance from the attached data source" time="0.008" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model Tests Model_removeById(id, [callback])"/>
    <testcase name="Find an instance by id" time="0.006" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model Tests Model_findById(id, callback)"/>
    ...
    <testcase name="Ensure the value for `property` is unique" time="0.006" classname="PhantomJS 1.9.7 (Mac OS X).Model / PersistedModel Model_validatesUniquenessOf(property, options)"/>
    ...
    <testcase name="Get the distance to another `GeoPoint`" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).GeoPoint geoPoint_distanceTo(geoPoint, options)"/>
    ...
    <testcase name="Expose a `Model` to remote clients" time="0.002" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(Model)"/>
    ...
    <testcase name="registers existing models to app.models" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(Model)"/>
    <testcase name="updates REST API when a new model is added" time="0" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(Model)">
      <skipped/>
    </testcase>
    <testcase name="uses plural name as shared class name" time="0" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(Model) in compat mode"/>
    <testcase name="uses plural name as app.remoteObjects() key" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(Model) in compat mode"/>
    ...
    <testcase name="prefers config.options.key over config.key" time="0" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(name, config)"/>
    <testcase name="honors config.public options" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(name, config)"/>
    <testcase name="defaults config.public to be true" time="0" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(name, config)"/>
    <testcase name="attaches the model to a datasource" time="0" classname="PhantomJS 1.9.7 (Mac OS X).app app_model(ModelCtor, config)"/>
    <testcase name="is unique per app instance" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).app app_models"/>
    <testcase name="is unique per app instance" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).app app_dataSources"/>
    ...
    <testcase name="adds the connector to the registry" time="0" classname="PhantomJS 1.9.7 (Mac OS X).app app_connector"/>
    ...
    <testcase name="is unique per app instance" time="0.001" classname="PhantomJS 1.9.7 (Mac OS X).app app_settings"/>
    <system-out><![CDATA[
]]></system-out>
    <system-err/>
  </testsuite>
